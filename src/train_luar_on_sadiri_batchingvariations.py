...
def train_datadreamer_ta2__on_performers_data(type_, train_path, dev_path, output_folder, used_loss, luar_model_path='./rrivera1849', batch_size=128, epochs=25):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--type_', type=str, choices=["get_anchorpos_random_batches", "anchorpos_rankingloss_hardbatches"], required=True, help="Type of data generator to use")
