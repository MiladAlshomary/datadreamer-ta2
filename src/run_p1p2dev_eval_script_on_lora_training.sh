...
if [ -z "$1" ]; then
  ...
  echo "Example: $0 sadiri_hardpos_rankingloss_random_hardbatching_v001_20250402_193508"
  exit 1
fi
...
BASE_INPUT_DIR="/data/araghavan/HIATUS/datadreamer-ta2/data/hrs/english_TA2_p1_and_p2_dev_20240207_v2/TA2"

# Derived paths
BASE_OUTPUT_DIR="/data/araghavan/HIATUS/datadreamer-ta2/data/hrs/english_TA2_p1_and_p2_dev_20240207_v2_outputs/p1p2dev_${BASE_DIR_NAME}"
LOGFILE="/data/araghavan/HIATUS/datadreamer-ta2/output/logs/p1p2dev_${BASE_DIR_NAME_NOSLASH}_eval_op.txt"
...
echo "==== Running P1 and P2 DEV Eval (RUN_ID=${RUN_ID}) ===="
echo "==== Running P1 and P2 DEV Eval (RUN_ID=${RUN_ID}) ====" >> "$LOGFILE"
